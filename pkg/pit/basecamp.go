...
// example key for assigning VLAN to another bond:
// "vlans": ["vlan002@bond0", "vlan004@bond0", "vlan007@bond0", "vlan010@bond1"],
var basecampGlobalString = `{
	"can-gw": "~FIXME~ e.g. 10.102.9.20",
	"can-if": "vlan007",
	"vlans": ["vlan002@bond0", "vlan004@bond0", "vlan007@bond0"],
